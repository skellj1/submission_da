...
LOOP2:				// Loop label for loop that will separate numbers that
	...
	BREQ END		// If the X register has reached its maximum memory location, branch
						// to the END label.
...
Y_REG:				// Subroutine to store numbers divisible by 3 in memory starting at 0x0400.
	...
	BREQ END		// Branch to the END label if X has reached its maximum memory location.
