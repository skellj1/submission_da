 ...
 */ 
 ...
 LOOP:							; Loop label for repeated (iterative) addition
	ADD R18, R24				; Begins repeated addition of the lower 8 bits of the multiplicand, 
	...
	ADC R20, R16				; Allocates bits 16-23 of the third solution register, initially adding 
